(function (e, $) {
    ...
    var fb = {
        ...
        gb = [{n: "p", t: "\u666e\u901a\u6bb5\u843d"}, {n: "h1", t: "\u6807\u98981"}, {
            n: "h2",
            t: "\u6807\u98982"
        }, {n: "h3", t: "\u6807\u98983"}, {n: "h4", t: "\u6807\u98984"}, {n: "h5", t: "\u6807\u98985"}, {
            n: "h6",
            t: "\u6807\u98986"
        }, {n: "pre", t: "\u5df2\u7f16\u6392\u683c\u5f0f"}, {
            n: "address",
            t: "\u5730\u5740"
        }], hb = [{n: "\u5b8b\u4f53", c: "SimSun"}, {n: "\u4eff\u5b8b\u4f53", c: "FangSong_GB2312"}, {
            n: "\u9ed1\u4f53",
            c: "SimHei"
        }, {n: "\u6977\u4f53", c: "KaiTi_GB2312"}, {
            n: "\u5fae\u8f6f\u96c5\u9ed1",
            c: "Microsoft YaHei"
        }, {n: "Arial"}, {n: "Arial Black"},
            {n: "Comic Sans MS"}, {n: "Courier New"}, {n: "System"}, {n: "Times New Roman"}, {n: "Tahoma"}, {n: "Verdana"}], T = [{
            n: "x-small",
            s: "10px",
            t: "\u6781\u5c0f"
        }, {n: "small", s: "12px", t: "\u7279\u5c0f"}, {n: "medium", s: "16px", t: "\u5c0f"}, {
            n: "large",
            s: "18px",
            t: "\u4e2d"
        }, {n: "x-large", s: "24px", t: "\u5927"}, {n: "xx-large", s: "32px", t: "\u7279\u5927"}, {
            n: "-webkit-xxx-large",
            s: "48px",
            t: "\u6781\u5927"
        }], ib = [{s: "\u5de6\u5bf9\u9f50", v: "justifyleft"}, {
            s: "\u5c45\u4e2d",
            v: "justifycenter"
        }, {s: "\u53f3\u5bf9\u9f50", v: "justifyright"}, {
            s: "\u4e24\u7aef\u5bf9\u9f50",
            v: "justifyfull"
        }], jb = [{s: "\u6570\u5b57\u5217\u8868", v: "insertOrderedList"}, {
            s: "\u7b26\u53f7\u5217\u8868",
    ...
    var lb = {a: "Link", img: "Img", embed: "Embed"}, mb = {
        "<": "&lt;",
        ">": "&gt;",
        '"': "&quot;",
        "\u00ae": "&reg;",
        "\u00a9": "&copy;"
    }, nb = /[<>"\u00ae\u00a9]/g, ra = function (z, o) {
        function q(a) {
        ...
        this.processHTML = function (a,
            ...
            if ("write" === b) {
                a = a.replace(/(<(\/?)(\w+))((?:\s+[\w\-:]+\s*=\s*(?:"[^"]*"|'[^']*'|[^>\s]+))*)\s*((\/?)>)/g, function (a, b, c, d, e, f, i) {
                    ...
                    var k, y = "";
                    if ("del" === d)d = "strike"; else if ("img" === d)e = e.replace(/\s+emot\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/i, function (a, b) {
                        k = b.match(/^(["']?)(.*)\1/)[2];
                        k = k.split(",");
                        k[1] || (k[1] = k[0], k[0] = "");
                        "default" === k[0] && (k[0] = "");
                ...
                if (R)for (var d = [{
                    ...
                    t: "u"
                }, {r: /text-decoration\s*:\s*line-through;?/ig, t: "strike"}], c = function (a, b, c, e, i) {
        ...
        this.toggleSource = function (a) {
            if (x !== a) {
                ...
                n.find(".xheButton").not("[cmd=Source],[cmd=Fullscreen],[cmd=About]").toggleClass("xheEnabled").attr("aria-disabled",
                    x ? !0 : !1);
                setTimeout(La, 300)
            }
        };
        this.showPreview = function () {
            var a = g.beforeSetSource, b = d.getSource();
            a && (b = a(b));
            var a = "<html><head>" + P + "<title>\u9884\u89c8</title>" + (F ? '<base href="' + F + '"/>' : "") + "</head><body>" + b + "</body></html>", b = window.screen, b = window.open("", "xhePreview", "toolbar=yes,location=no,status=yes,menubar=yes,scrollbars=yes,resizable=yes,width=" + Math.round(0.9 * b.width) + ",height=" + Math.round(0.8 * b.height) + ",left=" + Math.round(0.05 * b.width)), c = b.document;
            c.open();
            c.write(a);
            c.close();
            b.focus()
        ...
        this.toggleFullscreen = function (a) {
            if (la !== a) {
                var a = e("#" + ja).find(".xheLayout"), b = e("#" + ja), c = jQuery.browser.version, c = h && (6 == c || 7 == c);
        ...
        this.showAnchor = function () {
            var a = e('<div><label for="xheAnchorName">\u951a\u70b9\u540d\u79f0: </label><input type="text" id="xheAnchorName" value="" class="xheText" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="\u786e\u5b9a" /></div>'), b = d.getParent("a"), c = e("#xheAnchorName", a), f = e("#xheSave", a);
            if (1 === b.length) {
        ...
        this.startUpload = function (a, b, c, f) {
            ...
            var m = [], j = g.html5Upload, p = j ? g.upMultiple : 1, h, s = e('<div style="padding:22px 0;text-align:center;line-height:30px;">\u6587\u4ef6\u4e0a\u4f20\u4e2d\uff0c\u8bf7\u7a0d\u5019\u2026\u2026<br /></div>'), r = '<img src="' + ua + 'img/loading.gif">';
        ...
        this.html4Upload = function (a, b,
                                     c) {
            var d = "jUploadFrame" + (new Date).getTime(), g = this, h = e('<iframe name="' + d + '" class="xheHideArea" />').appendTo("body"), j = e('<form action="' + b + '" target="' + d + '" method="post" enctype="multipart/form-data" class="xheHideArea"></form>').appendTo("body"), p = e(a), l = p.clone().attr("disabled", "true");
        ...
        this.showIframeModal = function (a, b, c, f, g, h) {
            ...
            var b = e('<iframe frameborder="0" src="' + b.replace(/{editorRoot}/ig, A) + (/\?/.test(b) ? "&" : "?") + "parenthost=" + location.host + '" style="width:100%;height:100%;display:none;" /><div class="xheModalIfmWait"></div>'), o = b.eq(0), s = b.eq(1);
        ...
        this.showPanel = function (a,
            ...
            var c = da.offset(), d = c.left, c = c.top, c = c + (da.outerHeight() - 1);
