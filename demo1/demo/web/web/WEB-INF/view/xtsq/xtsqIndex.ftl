...
<div class="right_content" id="rightContent">
    <iframe name="xtsqRight" id="xtsqRight" frameborder="0" width="100%" height="100%" scrolling="auto" src="${base}/xtsq/xtsqRight"></iframe>
</div>
<script type="text/javascript" language="javascript">
    ...
    var asyncLoad = function () {
        ...
        $.post("${base}/tree/getXtjgTree", null, function (data) {
            $.fn.zTree.init($("#xtjgTree"), setting, data);
        });
    };
    ...
    function ztreeOnclick(event, treeId, treeNode) {
        jgid = treeNode.id;
        window.frames['xtsqRight'].changeJgid(jgid);
    }
