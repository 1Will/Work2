...
<table cellpadding="0" cellspacing="0" border="0" class="list" id="tbColor">
    ...
    <#if xtjgList??&&xtjgList?size gt 0>
        <#list xtjgList as o>
            <tr class="<#if o_index%2==0>trhover<#else>se trhover</#if>">
                ...
                <td title="${(o.JGDM)!''}">${(o.JGDM)!''}</td>
                <td title="${(o.SJJGMC)!''}">${(o.SJJGMC)!''}</td>
                <td title="${(o.DHHM)!''}">${(o.DHHM)!''}</td>
                <td>
                    <a title="修改" href="javascript:void(0);" onclick="xtjgEdit('edit','${(o.ID)!}')">
                        <i class="iconfont">&#xe628;</i>
                    </a>
                    <a title="删除" href="javascript:void(0);" onclick="deleteXtjg('${(o.ID)!}')">
                        <i class="iconfont">&#xe61a;</i>
                    </a>
                </td>
            </tr>
